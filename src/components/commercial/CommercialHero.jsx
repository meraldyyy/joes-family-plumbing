...
export default function CommercialxHero() {
        ...
        <FadeIn direction="left">
          <div className="mx-auto max-w-xl text-center lg:mx-0 lg:text-left">
            ...
            <p className="mx-auto mt-5 max-w-xl text-[15px] leading-7 text-white/85 sm:text-lg lg:mx-0 lg:mt-7 lg:text-xl">
              Downtime costs money. Our commercial team delivers rapid repairs and scheduled maintenance so your doors stay open.
            </p>
